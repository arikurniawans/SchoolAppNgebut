...
<!--end::Wrapper-->
<!--begin::Button-->
<a href="{{ url('datafitur/create') }}" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
...
<script>
        $(document).ready(function() {
         ...
         var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "/datafitur/index",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex',className: "text-center"},
                {data: 'nama_fitur', name: 'nama_fitur'},
                {data: 'endpoint_fitur', name: 'endpoint_fitur'},
