            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <input type="hidden" name="id" value="{{$fitur->idfitur}}"/>
                        <label class="required fs-5 fw-bold mb-2">Nama Fitur</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nama" value="{{$fitur->nama_fitur}}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <!--end::Label-->
                        <label class="required fs-5 fw-bold mb-2">End Point Fitur</label> <font size="2px" color="gray">(ex. /guru)</font>
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="/..." name="endpoint" value="{{$fitur->endpoint_fitur}}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
