    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form action="{{ url('galeri/kategori/'. $edit->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input type="text" name="label" id="label" value="{{ old('label',$edit->label) }}" class="form-control @error('label') is-invalid @enderror" placeholder="Masukkan Label..">
                                @error('label')
