...
<div class="post d-flex flex-column-fluid" id="kt_post">
 ...
 <div class="row mb-5">
                ...
                <div class="d-flex flex-column mb-5 fv-row">
                    <!--begin::Label-->
                    <label class="required fs-5 fw-bold mb-2">Nomor Telpon Sekolah</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                ...
                <div class="d-flex flex-column mb-5 fv-row">
                    <!--begin::Label-->
                    <label class="fs-5 fw-bold mb-2">Kota</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                ...
                <div class="row g-9 mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Provinsi</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Kode Pos</label>
                        <!--end::Label-->
                        <!--begin::Input-->
