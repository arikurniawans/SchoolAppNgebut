                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users" role="grid">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0);" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_card{{$data->idmapelampu}}">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/dataguru/hapusmapel/{{$data->idmapelampu}}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                            ...
                            <div class="modal fade" id="kt_modal_edit_card{{$data->idmapelampu}}" tabindex="-1" aria-hidden="true">
                                ...
                                <form name="kelasinput" id="kelasinput" method="post" action="/dataguru/updatemapel">
                                    {{ csrf_field() }}
                                    <div class="row mb-5">
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="hidden" name="idmapel" value="{{$data->idmapelampu}}"/>
                                             <select name="mapel" class="form-select form-select-solid" id="mapel">
                                                <option value="">Pilih Mapel...</option>
                                                <option value="{{$data->idmapel}}" selected>({{$data->kode_mapel}}) - {{$data->nama_mapel}}</option>
                                                @foreach($tblmapel as $mapel)
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                             <input type="number" name="jumlah_jam" class="form-control" placeholder="" value="{{$data->jumlah_jam}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <div class="col-md-6 fv-row">
...
<div class="modal fade" id="kt_modal_new_card" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
    <div class="modal-header">
    <h2>Tambah Mapel yang di ampu</h2>
    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
        <span class="svg-icon svg-icon-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
    <form name="kelasinput" id="kelasinput" method="post" action="/dataguru/storemapel">
        {{ csrf_field() }}
        <div class="row mb-5">
                        <!--begin::Col-->
                        <input type="hidden" name="idguru" value="{{$idguru}}"/>
