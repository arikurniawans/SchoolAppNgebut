                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users" role="grid">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0);" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_card{{$data->idkeluarga}}">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/dataguru/hapuskeluarga/{{$data->idkeluarga}}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                            ...
                            <div class="modal fade" id="kt_modal_edit_card{{$data->idkeluarga}}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                <div class="modal-header">
                                <h2>Ubah Anggota Keluarga</h2>
                                ...
                                <form name="kelasinput" id="kelasinput" method="post" action="/dataguru/updatekeluarga">
                                    {{ csrf_field() }}
                                    <div class="row mb-5">
                                                    <!--begin::Col-->
                                                    <div class="col-md-6 fv-row">
                                                        ...
                                                        <input type="hidden" name="idklg" value="{{$data->idkeluarga}}"/>
                                                        <label class="required fs-5 fw-bold mb-2">Nama Anggota keluarga</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                         <input type="text" name="nama" id="nama" class="form-control" placeholder="" value="{{$data->nama_keluarga}}"/>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                                                    <div class="col-md-6 fv-row">
                                                        ...
                                                        <!--begin::Input-->
                                                         <select name="hubungan" class="form-select form-select-solid" id="hubungan">
                                                            ...
                                                            <option value="{{$data->hubungan}}"selected>{{ucwords($data->hubungan)}}</option>
                                                    ...
                                                    <div class="col-md-6 fv-row">
                                                        ...
                                                        <input type="text" name="tempatlahirkeluarga" id="tmplahir" class="form-control" placeholder="" value="{{$data->tempat_lahir}}"/>
                                                    </div>
                                                    <div class="col-md-6 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="required fs-5 fw-bold mb-2">Tanggal Lahir</label>
                                                        <input type="date" name="tgllahirkeluarga" id="tgllahir" class="form-control" placeholder="" value="{{$data->tgl_lahir_keluarga}}"/>
                                                    </div>
...
<div class="modal fade" id="kt_modal_new_card" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
    <form name="kelasinput" id="kelasinput" method="post" action="/dataguru/storekeluarga">
        {{ csrf_field() }}
        <div class="row mb-5">
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                        ...
                        <div class="col-md-6 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-5 fw-bold mb-2">Tempat Lahir</label>
                            <input type="text" name="tempatlahirkeluarga" id="tmplahir" class="form-control" placeholder=""/>
                        </div>
                        <div class="col-md-6 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-5 fw-bold mb-2">Tanggal Lahir</label>
                            <input type="date" name="tgllahirkeluarga" id="tgllahir" class="form-control" placeholder=""/>
                        </div>
