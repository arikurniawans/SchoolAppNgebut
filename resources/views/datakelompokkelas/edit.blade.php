...
<a href="{{ url('datakelompokkelas') }}" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="kode" value="{{$data->kode_kelompok}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="jurusan" value="{{$data->jurusan_kelompok}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
