            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <option value="{{$data->idsettingtahun}}" selected>{{$data->tahunakademik}}</option>
                        ...
                        <!--begin::Select-->
                               <select name="kelas" class="form-select form-select-solid">
                                  <option value="" disabled selected>Pilih Kelas...</option>
                                   <option value="{{$data->idruangkelas}}" selected>{{$data->idruangkelas}}</option>
                                   <option value="X">X</option>
                                   <option value="XI">XI</option>
                                   <option value="XII">XII</option>
                                </select>
                     ...
                     <!--end::Label-->
                               ...
                               <!--begin::Select-->
                                <select name="jurusan" id="jurusan" class="form-select form-select-solid">
                                      ...
                                      <option value="{{$data->idjurusan}}" selected>{{ strtoupper($data->idjurusan) }}</option>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--begin::Input-->
                         <select name="rombel" class="form-select form-select-solid">
                          ...
                          <option value="{{$data->idkelompokkls}}" selected>{{$data->nama_kelompok}}</option>
                          @foreach($kelompok as $klp)
                            <option value="{{$klp->idkelompokkls}}">{{$klp->nama_kelompok}}</option>
                          @endforeach
                        </select>
                        <!--end::Input-->
                    </div>
