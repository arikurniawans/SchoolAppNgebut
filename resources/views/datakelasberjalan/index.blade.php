...
<!--end::Wrapper-->
<!--begin::Button-->
<a href="{{ url('datakelasberjalan/create') }}" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
...
<script>
        $(document).ready(function() {
         ...
         var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "/datakelasberjalan/index",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex',className: "text-center"},
                {data: 'tahunakademik', name: 'tahunakademik'},
                {data: 'tingkat_kelas', name: 'tingkat_kelas'},
                {data: 'idruangkelas', name: 'idruangkelas'},
                {data: 'jurusan_kelompok', name: 'jurusan_kelompok'},
