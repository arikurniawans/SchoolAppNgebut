...
<!--end::Wrapper-->
<!--begin::Button-->
<a href="{{ url('datamatapelajaran/create') }}" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
