...
<a href="{{ url('datainputnilai') }}" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
...
<div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <option value="Protestan">Bahasa Indonesia</option>
                        <option value="Protestan">Bahasa Inggris</option>
                        </select>
                        <!--end::Select-->
                    </div>
                    <!--end::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="required fs-5 fw-bold mb-2">Guru Mepel</label>
                        <!--end::Label-->
                        <!--begin::Select-->
                        <select name="agama" class="form-select form-select-solid">
                        <option value="">Silahkan Pilih Guru Mapel...</option>
                        <option value="Islam">Tom Holland S.Pd</option>
                        <option value="Protestan">Tobey MacGurray S.Pd</option>
                        <option value="Protestan">Andrew Garfield S.Pd</option>
                        </select>
                        <!--end::Select-->
                    </div>
                    <!--end::Col-->
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <option value="Islam">Senin</option>
                        <option value="Protestan">Selasa</option>
                        <option value="Protestan">Rabu</option>
                        <option value="Protestan">Kamis</option>
                        <option value="Protestan">Jumat</option>
                        <option value="Protestan">Sabtu</option>
                        </select>
                        <!--end::Select-->
                    </div>
                    <!--end::Col-->
  ...
  <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="time" class="form-control form-control-solid" placeholder="" name="NIK" />
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
