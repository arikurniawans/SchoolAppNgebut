...
class DatainputnilaiController extends Controller
{
    //
    ...
    public function getCreate() {
         ...
         * Nah ini return views yang sudah dijelaskan pada komen diatas disertai dengan data yang akan kita passing ke view
         */
        return view('Datainputnilai.create', $data);
    }
    ...
    public function getSetjadwal() {
         ...
         * Nah ini return views yang sudah dijelaskan pada komen diatas disertai dengan data yang akan kita passing ke view
         */
        return view('datainputnilai.setjadwal', $data);
    }
